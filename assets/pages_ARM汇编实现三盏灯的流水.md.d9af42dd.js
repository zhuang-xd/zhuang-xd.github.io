import{_ as s,o as n,c as a,O as l}from"./chunks/framework.4afe7240.js";const y=JSON.parse('{"title":"ARM汇编实现三盏灯的流水","description":"","frontmatter":{"tags":"应用","title":"ARM汇编实现三盏灯的流水","date":"2023-06-06T00:00:00.000Z"},"headers":[],"relativePath":"pages/ARM汇编实现三盏灯的流水.md","filePath":"pages/ARM汇编实现三盏灯的流水.md","lastUpdated":1686218490000}'),p={name:"pages/ARM汇编实现三盏灯的流水.md"},e=l(`<h1 id="arm汇编实现三盏灯的流水" tabindex="-1">ARM汇编实现三盏灯的流水 <a class="header-anchor" href="#arm汇编实现三盏灯的流水" aria-label="Permalink to &quot;ARM汇编实现三盏灯的流水&quot;">​</a></h1><h2 id="思路" tabindex="-1">思路 <a class="header-anchor" href="#思路" aria-label="Permalink to &quot;思路&quot;">​</a></h2><table><thead><tr><th>第一秒</th><th>第二秒</th><th>第三秒</th></tr></thead><tbody><tr><td>LED3灭</td><td>LED1灭</td><td>LED2灭</td></tr><tr><td>LED1亮</td><td>LED2亮</td><td>LED3亮</td></tr></tbody></table><h2 id="代码" tabindex="-1">代码 <a class="header-anchor" href="#代码" aria-label="Permalink to &quot;代码&quot;">​</a></h2><p>参考 <a href="./点亮FSMP1A开发板的LED1.html">点亮FSMP1A开发板的LED1</a></p><div class="language-nasm"><button title="Copy Code" class="copy"></button><span class="lang">nasm</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">.text </span></span>
